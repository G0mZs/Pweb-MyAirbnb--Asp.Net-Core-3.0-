...
{
    public partial class createAirbnb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryName = table.Column<string>(type: "nvarchar(58)", maxLength: 58, nullable: false),
                    ...
                    HasDailyCleaning = table.Column<bool>(type: "bit", nullable: false),
                    HasCleaningProducts = table.Column<bool>(type: "bit", nullable: false),
                    HasFreeParking = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checklist_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationState = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProceduresId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    ProcedureResult = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Procedures", x => x.ProceduresId);
                    table.ForeignKey(
                        name: "FK_Procedures_Checklist_ChecklistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomRating = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Checklist_RoomId",
                table: "Checklist",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Procedures_ChecklistId",
                table: "Procedures",
                column: "ChecklistId");
